...
- (void)dismissViewControllerAnimated:(BOOL)flag backToViewController:(UIViewController *_Nonnull)controller withBundle:(TransBundle *_Nullable)bundle completion:(void (^ __nullable)(void))completion NS_AVAILABLE_IOS(5_0);
